---
id: snapshot-location-penbrok-preplay-baseline
record_type: location_snapshot
reference_name: Penbrok — prepared pre-play baseline
location: ../../entities/locations/location-penbrok-fortress.md
time:
  description: The prepared starting state before play; the exact fictional date and duration are not recorded. The DOCX creation and modification timestamps are real-world preparation metadata only.
  sources:
...
- [GM preparation](../../sources/campaigns/campaign-dopisy-z-panstvi-penbrok/000-Hrad-Penbrok.docx) — opening description and keys 1–7.
